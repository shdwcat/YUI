/// @description YUI Renderer that draws a line from one point to another
function YuiLineRenderer(_props, _resources, _slot_values) : YuiBaseRenderer(_props, _resources, _slot_values) constructor {
