...
function __fileSystemGetSingleton() {
    ...
    if (is_undefined(_instance)) {
        ...
        switch(os_type) {
            ...
            case os_windows: 
                _instance.filePath = environment_get_variable("userprofile") + string("\\Documents\\") + game_project_name + "\\"; 
            break;
            ...
            case os_macosx: 
            case os_linux: 
                _instance.filePath = environment_get_variable("HOME") + string("\\Documents\\") + game_project_name + "\\"; 
            break;
